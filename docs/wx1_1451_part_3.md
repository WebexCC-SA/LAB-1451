...
???+ lesson "Defining our `OpenSite` function"
        ...
        ??? example "View `openSite(url, target)` function"
            ...
            async function openSite(url, target = 'OSD') {
              try {
                ...
                console.log(`Webview Opened for: [${url}]`, openPage);
              } catch (e) {
                const err = {
                  Context: `Failed to open WebView to: [${url}]`,
                  ...e
                };
                console.error(err);
              }
    ...
    ??? success "Compare your Macro"
        ...
        async function openSite(url, target = 'OSD') { //<-- Declare and define your openSite function
          try {
            ...
            console.log(`Webview Opened for: [${url}]`, openPage);  //<-- Log a Successful Response
          } catch (e) {
            const err = {
              Context: `Failed to open WebView to: [${url}]`,
              ...e
    ...
    ??? success "Compare your Macro Console"
        ...
        |-----------|-----------|--------------------------------------------------------------------|
        | HH:MM:SS  | Room Docs | QJS Ready                                                          |
        | HH:MM:SS  | Room Docs | Webview Opened for: [https://webexcc-sa.github.io/LAB-1451/wx1_1451_part_3/] {"status":"OK"} |
        | HH:MM:SS  | Room Docs | OpenQrCode  https://webexcc-sa.github.io/LAB-1451/wx1_1451_part_3/  |
        | HH:MM:SS  | Room Docs | Webview Opened for: [https://www.webex.com/us/en/workspaces.html] {"status":"OK"} |
        | HH:MM:SS  | Room Docs | OpenQrCode  https://www.webex.com/us/en/workspaces.html          |
...
??? lesson "Defining our `OpenQrCode` function"
    ...
    !!! tip "Making QR Codes is NOT a normal function of the Codec"
        ...
        !!! important "Always Keep Security Top of Mind!"
            ...
            Make sure you work with your InfoSec, or your Customer's InfoSec teams, when implementing a new solution that requires Integration tokens or reaches out on the internet
