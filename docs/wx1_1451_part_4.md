...
??? cedeploy "4.14 Exercises Part 2"
    ...
    <figure markdown="span">
        ![Logs Panel](assets%2Fwx1_1451_part_4%2F4-14-8.png)
    </figure>
    ...
    <figure markdown="span">
        ![Message Console](assets%2Fwx1_1451_part_4%2F4-14-10.png)
    </figure>

    !!! Success

        Well done. You have explored the main features of CE-Deploy and a few lesser known ones. Feel free
        to explore and see what else it can do. CE-Deploy is built on public API's free available to everyone
