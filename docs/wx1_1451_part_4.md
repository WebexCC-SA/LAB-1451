...
4.9.6 Everytime you select process code a new QR COde file is generated with a timestamp embedded in the name.
For example code-09_47_51_582.jpeg. Feel free to generate as many codes as you like
but you will need to pick on for the next step.
