...
!!! abstract
    ...
    However, some features, like bulk macro management, are still unique to CE-Deploy. In 
...
!!! important "CE-Deploy Install"
    ...
    Before we begin our next lab if you have not already you will need to download and install CE-Deploy using one of the links below:
...
??? lesson "4.7 Lessons"
    ...
    <figure markdown="span">
      ![Webex Signin](assets%2Fwx1_1451_part_4%2F5-1-2.png){ width="300" }
      <figcaption></figcaption>
    </figure>
    ...
    <figure markdown="span">
      ![Environments](assets%2Fwx1_1451_part_4%2F4-7-3.png){ width="300" }
      <figcaption></figcaption>
    </figure>
    ...
    <figure markdown="span">
      ![Load Environment](assets%2Fwx1_1451_part_4%2F4-7-5b.png){ width="300" }
      <figcaption></figcaption>
    </figure>
