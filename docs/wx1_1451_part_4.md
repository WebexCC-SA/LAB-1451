...
![4-10-21.png](assets%2Fwx1_1451_part_4%2F4-10-21.png)

4.10.22 This time around we are going to select the **Org Id**

![4-10-22.png](assets%2Fwx1_1451_part_4%2F4-10-22.png)
...
![4-10-24.png](assets%2Fwx1_1451_part_4%2F4-10-24.png)

You should now see the Macro Factory appear with all the pod endpoints that have added their macros.

![4-10-24b.png](assets%2Fwx1_1451_part_4%2F4-10-24b.png)
...
!!! Tips
    ...
    - Easy to use functions, no need to remember commands
    - Great for managment of a few endpoints adding, removing and activating macros
    - For bulk rollout of Macros using the Deployment panel Customizations->Macros is a better option
    
4.10. Now that we have our macro deployed we will turn our attention to deploying the accompanying
...
4.11. Under deployment Options use the dropdown to select Tags and enter your pod tag for your device.

![4-9-9a.png](assets%2Fwx1_1451_part_4%2F4-9-9a.png)

4.11. Ensure the **Video Devices Only** checkbox is checked.

4.11. Press button Start Deployment.

4.11. Ensure the **Scheduler** has the **Run Deployment Now** check box selected and click **Next**.

4.11. The Message Console will now appear, you can follow along the deployment process.
...
4.12. Under deployment Options use the dropdown to select Tags and enter your pod tag for your device.

![4-9-9a.png](assets%2Fwx1_1451_part_4%2F4-9-9a.png)

4.12. Ensure the **Video Devices Only** checkbox is checked.

4.12. Press button Start Deployment.

4.12. Ensure the **Scheduler** has the **Run Deployment Now** check box selected and click **Next**.

4.12. The Message Console will now appear, you can follow along the deployment process.
