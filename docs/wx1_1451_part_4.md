...
???+ Tip "Intro to CE-Deploy Vidcast"
...
??? Install
    ...
    Windows -> <a target="blank" href="https://github.com/voipnorm/CE-Deploy/releases/download/v12.3.8/CE-Deploy-Installer.12.4.1.exe">Windows Installer</a>

    Mac -> <a target="blank" href="https://github.com/voipnorm/CE-Deploy/releases/download/v12.3.8/CE-Deploy-12.4.1.dmg"> Mac Installer</a>
...
4.7.3 In the deployment panel select "Environment".
...
4.7.5 To load our new environment, use the drop down in the Environment loading section and select your 
...
4.8.2 	2. Select xAPI from the deployment section. In the command text box enter:
```text
...
4.9.3 Add a tag using your pod ID

![5-3-3.png](assets%2Fwx1_1451_part_4%2F5-3-3.png)

4.9.4 The widespread adoption of QR codes has introduced unique advantages to branding. While 
...
4.10.1 Open CE-Deploy and select Design>Macro Editor
