...
!!! example "Please Follow Each Step"
    ...
    === "1.1 Factory Reset(Optional)"
        ...
        <figure markdown>
            ![Factory Reset](assets%2Fwx1_1451_part_1%2F4-1-1.png){ width="700" }
        </figure>

    === "1.2 Setup Device Defaults and Admin Account"
        
        <figure markdown>
            ![Defaults](assets%2Fwx1_1451_part_1%2F4-1-2a.png){ width="700" }
        </figure>

        <figure markdown>
            ![Network](assets%2Fwx1_1451_part_1%2F4-1-2b.png){ width="700" }
        </figure>

        <figure markdown>
            ![Registration](assets%2Fwx1_1451_part_1%2F4-1-2e.png){ width="700" }
        </figure>

        <figure markdown>
            ![Complete](assets%2Fwx1_1451_part_1%2F4-1-2d.png){ width="700" }
        </figure>
    ...
    === "1.3 Register to Webex"
        ...
        <figure markdown>
            ![Enter Device Home Page](assets%2Fwx1_1451_part_1%2F4-1-3a.png){ width="700" }
        </figure>

        <figure markdown>
            ![Register To Webex](assets%2Fwx1_1451_part_1%2F4-1-3b.png){ width="700" }
        </figure>
