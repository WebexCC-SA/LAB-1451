!!! important "Abstract"
    ...
    Part 2: Accessing Device xAPI will run through many examples on how you can interface with your Codec's xAPI through the following integration methods
    ...
    As you move forward in Part 2 of this lab, we'd love for you to cover all integration methods outlined throughout Part 2, but we understand it may be alot of information

    At a minimum, if you could review sections before the first hour concludes

    - 2.1
    - 2.2
    - 2.6

    These will lay the base ground work to come in Parts 3 and 4 of the remainder of this Lab

    Time Permitting, certainly check out sections 2.3, 2.4 and 2.5
...
???+ blank "Execute an xCommand"
    ...
    - Once the Body has been updated, ==Save== the request, select ==Send== and monitor the Postman Response Terminal and observe any changes to your device
...
!!! important "Section Requirements"
    ...
    Download the ==WX1-Lab:1451-WebSocket-PostMan-Collection== Postman Collection below

    <div class="grid cards" markdown>

    - <i class="fa-solid fa-download"></i> __Click the icon below for the Section 2.4 Postman Collection__
...
### **2.4.2 - Import and Configure the section 2.4 Postman Collection**
...
- With Postman open, in a new or existing workspace select ==import==
- Select File
- Locate the ==WX1-Lab:1451-WebSocket-PostMan-Collection.postman_collection.json== and Open it
- You should now have the Postman Collection installed for this lab
...
<h4>Configure Postman Collection for sections 2.4.3 through 2.4.6</h4>

- Click on the ==WX1-Lab:1451-WebSocket-PostMan-Collection== root folder
- Select Variables
- Add the following information for your codec in both the `Initial Value` and `Current Value` fields
    - device_ipAddress
    - device_base64_encoded_auth
        - You can use this labs <a href="../tools/" target="_blank">Base64 Conversion Tool <i class="fa-solid fa-square-up-right"></i></a> to convert your Device Username and Password to base64
        - String Format for base64 conversion ==admin:password==
- Select Save (or one of the keyboard shortcuts for your computer)
    - ++control+s++ for Windows
    - ++command+s++ for Mac

??? gif "View Configure Postman Collection for sections 2.4.3 through 2.4.6"

    <figure markdown>
      ![Import Lab Postman Collection](./assets/wx1_1451_part_2/2-4-2_Configure-PostmanCollection.gif){ width="600" }
    </figure>
...
???+ blank "Execute an xCommand"
    ...
    !!! info inline end "XML Body Location"
        ...
        <figure markdown>
          ![JSON body location](./assets/wx1_1451_part_2/2-4-3_Execute-xCommand-BodyLocation.png){ width="400" }
        </figure>

    - **xAPI:** xCommand Video Selfview Set

    - **Task:** Assign the correct ==Method== to the `method` object for xCommands and fill in the `params` object using the following parameters
        - Mode: On
        - FullScreenMode: On
        - OnMonitorRole: First
    ...
    - Once the Message body has been updated
        ...
        - select ==Send== and monitor the Postman Response Terminal and observe any changes to your device
    ...
    ??? question "Need Help with the Syntax?"
        ...
        <a class="md-button md-button--primary" href="../cheatsheet/#__tabbed_1_1" target="_blank" >
    ...
    ??? success "View properly formatted Message and Successful Response"
        ...
        ![Successful HTTP Response](./assets/wx1_1451_part_2/2-4-3_xCommand-Single-Success.png){ width="500", align=right }

        ``` { .json , .no-copy , title="JSON"}
        {
          "jsonrpc": "2.0",
...
??? blank "Execute an xCommand with multiple arguments with the same name"
    ...
    - **Task:** Assign the correct ==Method== to the `method` object for xCommands and fill in the `params` object using the following parameters, but duplicate the ConnectorId
        - ConnectorId: 1
        - Layout: Equal
    ...
    ??? success "View properly formatted Message and Successful Response"
        ...
        ![Successful HTTP Response](./assets/wx1_1451_part_2/2-4-3_xCommand-SameName-Success.png){ width="500", align=right }
...
### **2.4.4 - Getting, Setting and Subscribing to xConfiguration**
...
??? blank "Unsubscribing to an xConfiguration"
...
??? blank "Get multiple xStatuses Values under a common Node"
...
!!! Abstract
    ...
    They operate similarly to HTTP Requests, but differ in the sens that you're not directly communicating to the endpoint in a 1:1 socket like we would with every other protocol we offer

    You instead make a request, or offer a WebHook, to the Webex Cloud and then your cloud instance will broker the communication between itself and the device
...
### **2.4.  - Get and Configure your Developer Token in Postman**

### **2.4. - Executing xCommands**
...
### **2.4. - Getting and Setting to xConfigurations**
...
??? curios ":thinking: What about Subscribing to an xConfiguration?"

### **2.4. - Getting xStatuses**

??? blank "Getting an xStatus Value"

??? blank "Get multiple xStatus Values under a common Node"

### **2.4. - Subscribing to xConfigurations, xStatuses and xEvents**
