...
<details><summary>Click to Compare Terminal Output</summary>
  ``` {.shell, .no-copy}
         - User Commands -
...
???+ blank "Execute an xCommand"
    ...
    <a class="md-button md-button--primary" href="https://roomos.cisco.com/xapi/Command.Video.Selfview.Set/" target="_blank" rel="noopener noreferrer">
      Learn More about <strong>xCommand Video Selfview Set</strong> <i class="fa-solid fa-square-up-right"></i>
    </a>



??? blank "Execute a command with multiple arguments with the same name"
    ...
    <a class="md-button md-button--primary" href="https://roomos.cisco.com/xapi/Command.Video.Input.SetMainVideoSource/" target="_blank" rel="noopener noreferrer">
...
??? blank "Execute a Command which generates data and responds"
    !!! info
