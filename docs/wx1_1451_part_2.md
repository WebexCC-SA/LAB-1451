...
!!! blank ""
    ...
    | `Authorization`             | `Base [YOUR_BASE64_ENCODED_AUTH]` |
...
???+ blank "Execute an xCommand"
    ...
    - Once the Body has been updated, ==Save== the request, select ==Send== and 
    ...
    ??? failure "View Failed Response"
        ...
        <figure markdown>
          ![Failed HTTP Response](./assets/wx1_1451_part_2/2-3-3_Execute-xCommand-Failure.png){ width="600" }
        </figure>
...
??? blank "Execute multiple xCommands in a single request"
    ...
    ??? failure "View Failed Response"
        ...
        <figure markdown>
          ![Failed HTTP Response](./assets/wx1_1451_part_2/2-3-3_Execute-xCommand-MultipleCommands-Failure.png){ width="600" }
        </figure>
...
### **2.3.4 - Getting and Setting xConfigurations**
