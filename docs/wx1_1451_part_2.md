...
!!! blank ""
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="white-space: nowrap;"><code>aut-[YOUR_BASE64_ENCODED_AUTH]</code></td>
    ...
    All WebSocket messages are formatted in JSON. They require the following Objects to be successfull
    ...
    !!! example "View Message Examples with Parameters and Responses"
