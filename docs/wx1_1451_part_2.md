...
???+ lesson "Execute an xCommand"
    ...
    - Once the Body has been updated, ==Save== the request, select ==Send== and monitor the Postman Terminal and observe any changes to your device
...
???+ lesson "Execute an xCommand"
    ...
    - Once the Message body has been updated
        ...
        - select ==Send== and monitor the Postman Terminal and observe any changes to your device
...
???+ lesson "Set a new xConfiguration Value"
    ...
    - **Task:** 
        ...
        - Once the Message body has been updated
            - ==Save== the request
            - Select ==Connect== to establish the WebSocket connection to the Codec
            - select ==Send== and monitor the Postman Terminal
