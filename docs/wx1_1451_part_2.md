...
???+ lesson "Lists All User Command Nodes"
...
??? lesson "Lists Terminal Preference Options"
...
??? lesson "List Device Command Node References"
...
??? lesson "List Device Status Node References"
    ``` shell title="Type into terminal and press Enter"
    xStatus ?
    ``` 
...
??? lesson "List Device Config Node References"
    ``` shell title="Type into terminal and press Enter"
    xConfiguration ?
    ``` 
...
??? lesson "List Device Event Node References"
    ``` shell title="Type into terminal and press Enter"
    xEvent ?
    ``` 
...
??? lesson "Search for an xAPI using a Wildcard `//`"
    ``` shell title="Type into terminal and press Enter"
    xConfig // Name ?
    ``` 
...
??? lesson "Execute an xCommand which generates data and responds"
    !!! info
...
???+ lesson "Getting an xConfiguration Value"
...
??? lesson "Subscribing to an xConfiguration"
...
??? lesson "Unsubscribing from an xConfiguration"
...
??? lesson "Subscribe to Multiple xConfigurations under a Common Node"
...
??? lesson "Unsubscribe to Multiple xConfigurations under a Higher Common Node"
...
???+ lesson "Getting an xStatus Value"
...
??? lesson "Subscribing to an xStatus"
...
??? lesson "Unsubscribing to an xStatus"
...
??? lesson "Subscribe to Multiple xStatuses under a Common Node"
...
??? lesson "Unsubscribe from all xStatuses"
...
???+ lesson "Subscribing to an xEvent"
...
??? lesson "Unsubscribing to an xEvent"
...
??? lesson "Subscribe to Multiple xEvents under a Common Node"
...
??? lesson "Unsubscribe from all xEvents"
...
??? lesson "Execute multiple xCommands in a single request"
...
??? lesson "Subscribe to the full xConfiguration Branch"
...
??? lesson "Subscribe to the full xStatus Branch"
    ...
    - **Task:**
        ...
        - Then select Send and Monitor the output on the Webhook.Site terminal
            ...
            - If you don't see anything come in, try changing your volume

??? lesson "Subscribe to the full xEvent Branch"
...
??? lesson "Subscribe to Specific Expressions on any Branch"
...
???+ lesson "Execute an xCommand"
    ...
    ??? success "View properly formatted Message and Successful Response"
        ...
        ``` { .json , .no-copy , title="Message Body `JSON`"  }
        {
          "jsonrpc": "2.0",
...
??? lesson "Execute an xCommand with a multiline argument"
    ...
    ??? success "View properly formatted Message and Successful Response"
        ...
        ![Successful HTTP Response](./assets/wx1_1451_part_2/2-4-3_xCommand-MultiLine-Success.png){ width="500", align=right }
...
??? lesson "Execute an xCommand which generates data and responds"
    ...
    ??? success "View properly formatted Message and Successful Response"
        ...
        ![Successful HTTP Response](./assets/wx1_1451_part_2/2-4-3_xCommand-DataResponse-Success.png){ width="500", align=right }
        ...
        === "Response Body"
            ...
            ``` { .json , .no-copy , title="Response Body `JSON`" }
            {
              "id": "Execute an xCommand with a multiline argument",
              "jsonrpc": "2.0",
              "result": {
...
???+ lesson "Set a new xConfiguration Value"
    ...
    - **Task:** Assign the correct ==Method== to the `method` object for setting xConfigurations and within the `params` object, fill in the `Path` object using the xAPI above and place it's new Configuration Value in the `Value` object
    ...
    ??? success "View properly formatted Message and Successful Response"
        ...
        ![Successful HTTP Response](./assets/wx1_1451_part_2/2-4-4_xConfiguration-OOO-Success.png){ width="500", align=right }
...
??? lesson "Getting an xConfiguration Value"
    ...
    - **Task:** Assign the correct ==Method== to the `method` object for setting xConfigurations and within the `params` object, fill in the `Path` object using the xAPI above
...
??? lesson "Query an xConfiguration Value"

    - **xAPI:** xConfiguration SystemUnit Name

    - **Task:** Assign the correct ==Method== to the `method` object for setting xConfigurations and within the `params` object, fill in the `Query` object using the xAPI above
...
??? lesson "Query an xConfiguration Value using a WildCard"
    ...
    - **Task:** Assign the correct ==Method== to the `method` object for setting xConfigurations and within the `params` object, fill in the `Query` object using the xAPI above. Be sure to treat `**` as a separate entity in the xAPI Path.
...
??? lesson "Subscribe and Unsubscribe to an xConfiguration"
...
??? lesson "Subscribe and Unsubscribe to Multiple xConfigurations under a Common Node"
...
???+ lesson "Getting an xStatus Value"
    ...
    ??? success "View properly formatted Message and Successful Response"
        ...
        ![Successful HTTP Response](./assets/wx1_1451_part_2/2-4-xStatus-OOO-Success.png){ width="500", align=right }

        ``` { .json , .no-copy , title="Message Body `JSON`"  }
        
        ```

??? lesson "Get multiple xStatuses Values under a Common Node"
...
??? lesson "Query an xStatus Value using a WildCard"
...
??? lesson "Subscribe and Unsubscribe to an xStatus"
...
??? lesson "Subscribe and Unsubscribe to Multiple xStatuses under a Common Node"
...
??? blank+ "Subscribe and Unsubscribe to an xEvent"
    ...
    ??? success "View properly formatted Message and Successful Response"
        ...
        ![Successful HTTP Response](./assets/wx1_1451_part_2/2-4-xEvent-OOO-Success.png){ width="500", align=right }
...
??? lesson "Get multiple xConfigurations under a Common Node"
...
???+ lesson "Subscribe and Unsubscribe to an xEvent"
