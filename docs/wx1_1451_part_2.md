...
??? blank "Subscribing to an xConfiguration"
    ...
    ??? curious "What do we mean by Subscribe?"
...
??? blank "Unsubscribing from an xConfiguration"
    ...
    ??? curious "Why bother with Unsubscribing?"
...
??? blank "Getting an xConfiguration Value"
    ...
    ??? failure "View Failed Response"
        ...
        An odd thing about xConfig Get Requests, is you'll still get a 200 OK if your auth and IP are correct when talking to the Codec
